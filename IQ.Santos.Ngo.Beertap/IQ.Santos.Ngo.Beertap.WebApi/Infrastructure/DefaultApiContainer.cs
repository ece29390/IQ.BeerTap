...
using IQ.Santos.Ngo.Beertap.Documentation.Installers;
using IQ.Santos.Ngo.Beertap.WebApi.Handlers;

using IQ.Santos.Ngo.Beertap.WebApi.Infrastructure.Installers;

using IQ.Platform.Framework.WebApi.Infrastructure;
using IQ.Santos.Ngo.Beertap.Model;
using IQ.Santos.Ngo.Beertap.WebApi.Hypermedia;
...
namespace IQ.Santos.Ngo.Beertap.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        readonly Assembly _apiDomainServicesAssembly = typeof(IOfficeServiceApi).Assembly;
        readonly Assembly _resourceMappersAssembly = typeof(OfficeServiceApi).Assembly;
        ...
        protected override Assembly ApiAppServicesAssembly { get { return typeof(OfficeServiceApi).Assembly; } }
